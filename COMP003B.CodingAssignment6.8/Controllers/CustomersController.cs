...
namespace COMP003B.CodingAssignment6._8.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(WebDevAcademyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // Get the books the customers purchased
            ViewBag.Books = from b in _context.Books
                join a in _context.BookPurchases on b.BookId equals a.BookId
